...
g++ -D OS_LIN  -fno-pie -Wextra -fexceptions -Wall -I/opt/prokee/system/inc/ -I../../../../source/ -fexpensive-optimizations -O3 -m32 -c ../../../../source/prompt/prompt.cpp -o ../../../../source/prompt/prompt.o
